...
namespace EVCS_Projekt.UI
{
    class UIConstructionPanel: UIPanel, UIActionListener
    {
        ...
        private UIButton hauptteilButton;
        ...
        public UIConstructionPanel(int width, int height, Vector2 position, UIActionListener listener) : base(width, height, position)
        {
        ...
        private void InitComponents()
        {
            ...
            hauptteilButton = new UIButton(initWidth, 100, new Vector2(0, 40),"") ;
        ...
        public void SetHauptteil(Hauptteil newHauptteil)
        {
            ...
            hauptteilButton.BackgroundTextur = newHauptteil.Icon;
            hauptteilButton.BackgroundColor = Color.White;
